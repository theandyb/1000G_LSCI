...
def main(chrom_prefix = "chr"):
  ...
  ref = Fasta("/net/snowwhite/home/beckandy/research/1000G_LSCI/reference_data/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna", as_raw=True)
